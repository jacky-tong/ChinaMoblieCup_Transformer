...
class CustomDetectionDataset(Dataset):
    ...
    def _get_transforms(self):
        ...
        if self.is_train:
            aug_list = [
                transforms.RandomResizedCrop(size=out_size, scale=(0.7, 1.3)),  # 扩大缩放范围
...
class DetectionHead(nn.Module):
    def __init__(self, embed_dim, num_classes, num_patches, dropout_rate=DROPOUT_RATE):
        super().__init__()
